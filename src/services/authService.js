...
//   if (user.onFidoVerificationStatus === 'pending') {
//     throw new CustomError('Verification already in progress', 400);
//   }

//   // 1. Create Onfido applicant
//   const applicantId = await onfido.createApplicant({
//     first_name: user.first_name,
//     last_name: user.last_name,
//     email: user.email
//   });
// console.log("applicant created",applicantId);
//   // 2. Submit check/workflow
//   const check = await onfido.submitCheck(applicantId); 
//   // OR for workflows: await onfido.submitWorkflowRun(applicantId, process.env.ONFIDO_WORKFLOW_ID);

//   // 3. Generate SDK token
//   const sdkToken = await onfido.generateSdkToken(applicantId);
...
//   return { sdkToken, applicantId, checkId: check.id };
// };
